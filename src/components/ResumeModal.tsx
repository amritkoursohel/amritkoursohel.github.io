...
<body>
  ...
  <div class="grid-2" style="margin-top: 10px;">
    <div>
      <div class="section-title" style="margin-top: 0;">Verified Certifications (21 Credentials)</div>
      <ul>
        <li><strong>LinkedIn Learning:</strong> Introduction to Artificial Intelligence (AI)</li>
        <li><strong>LinkedIn Learning:</strong> Cloud for Business: Developing a Cloud Center of Excellence</li>
        <li><strong>LinkedIn Learning:</strong> Holding Your Team Accountable &amp; People Management</li>
        <li><strong>LinkedIn Learning:</strong> Leadership Strategies for Women &amp; Employee Relations</li>
        <li><strong>LinkedIn Learning:</strong> Listening to Customers, Email Writing &amp; Emotional Intelligence</li>
        <li><strong>LinkedIn Learning:</strong> Critical Thinking, Decision-Making &amp; Organizational Ethics</li>
      </ul>
    </div>
    <div>
            ...
            <div className="p-6 md:p-10 overflow-y-auto space-y-8 text-gray-800 dark:text-neutral-200 text-sm leading-relaxed resume-scroll-body">
              ...
              <div className="text-center space-y-2 border-b border-gray-200 dark:border-neutral-800 pb-6 resume-section-item">
                ...
                <div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-1 text-xs text-gray-600 dark:text-neutral-400">
                  ...
                  >
                    <svg
                      className="w-3.5 h-3.5 fill-current text-slate-700 dark:text-neutral-300"
                      viewBox="0 0 24 24"
                    ...
                    <span>{PORTFOLIO_DATA.personalInfo.phone} (WhatsApp)</span>
                  </a>
                  <span>•</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 resume-section-item">
                <div>
                  <h4 className="text-xs font-bold tracking-wider text-slate-800 dark:text-neutral-200 uppercase mb-2 border-b border-gray-200 dark:border-neutral-800 pb-1 font-display flex items-center justify-between">
                    <span>Certifications</span>
                    <span className="text-[10px] text-emerald-600 dark:text-emerald-400 font-semibold lowercase">21 verified credentials</span>
                  </h4>
                  <ul className="text-xs text-gray-700 dark:text-neutral-300 space-y-1">
                    ...
                    <li>• <strong>LinkedIn Learning:</strong> Listening to Customers, Email Writing &amp; Emotional Intelligence</li>
                    <li>• <strong>LinkedIn Learning:</strong> Critical Thinking, Decision-Making &amp; Organizational Ethics</li>
                    <li className="pt-1 text-[11px] text-slate-500 dark:text-neutral-400 italic">
                      + 15 additional verified LinkedIn Learning certifications in Operations, Productivity &amp; Communication
                    </li>
                  </ul>
                </div>
                <div>
